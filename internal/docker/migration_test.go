...
func TestMigrateContainerToTarget_Success(t *testing.T) {
	...
	err := mgr.MigrateContainerToTarget(ctx, "test_container", "1.2.3.4", 2222, "deploy", "private-key", false, nil)
	if err != nil {
...
func TestMigrateContainerToTarget_FailInspect(t *testing.T) {
	...
	err := mgr.MigrateContainerToTarget(ctx, "fail_inspect", "1.2.3.4", 2222, "deploy", "private-key", false, nil)
	if err == nil {
...
func TestMigrateContainerToTarget_FailCommit(t *testing.T) {
	...
	err := mgr.MigrateContainerToTarget(ctx, "fail_commit", "1.2.3.4", 2222, "deploy", "private-key", false, nil)
	if err == nil {
...
func TestMigrateContainerToTarget_FailSSH(t *testing.T) {
	...
	err := mgr.MigrateContainerToTarget(ctx, "test_container", "fail_ssh", 2222, "deploy", "private-key", false, nil)
	if err == nil {
